...
from utils import (get_answers, input_to_squad_example,
...
class QA:
    ...
    def predict(self,passage :str,question :str):
        ...
        answers = get_answers(example,features,all_results,self.n_best_size,self.max_answer_length,self.do_lower_case)
        return answers
